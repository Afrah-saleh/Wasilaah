...
struct Summary: View {
    ...
    private var congratsMessage: some View {
        VStack(spacing: 20) {
            Text("Congrats")
                .font(.title)
                .bold()
...
struct Summary_Previews: PreviewProvider {
    static var previews: some View {
        Summary(cardID: "1234", cardViewModel: CardViewModel(), authViewModel: sessionStore(), expensesViewModel: ExpensesViewModel(cardID: "1234"))
    }
}
